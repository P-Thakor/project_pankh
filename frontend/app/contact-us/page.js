  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/jaysir.jpg" alt="Jay Patel" className="object-cover w-40 h-40 mb-3 rounded-full" />
      ...
      {/* Member 2 */}
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/parth.png" alt="Parth Thakor" className="object-cover w-40 h-40 mb-3 rounded-full" />
      ...
      {/* Member 3 */}
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/kandarp.jpg" alt="Kandarp Vyas" className="object-cover w-40 h-40 mb-3 rounded-full" />
      ...
      {/* Member 4 */}
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/hemax.png" alt="Hemax Patel" className="object-cover w-40 h-40 mb-3 rounded-full" />
      ...
      {/* Member 5 */}
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/namra.png" alt="Namra Vekariya" className="object-cover w-40 h-40 mb-3 rounded-full" />
      ...
      {/* Member 6 */}
      <div className="flex flex-col items-center p-4 bg-blue-100 border border-blue-200 rounded-lg shadow-md">
        <img src="/assets/images/atmiy.png" alt="Atmiy Vithani" className="object-cover w-40 h-40 mb-3 rounded-full" />
