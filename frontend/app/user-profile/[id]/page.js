      ...
      </div>
      {
        isBlackListed && (
          <div className="p-4 text-center bg-red-200 text-red-800">
            <p>This user has been blacklisted due to their consecutive absences</p>
            <button className="mt-2 px-4 py-2 bg-red-500 text-white rounded" onClick={handleActivateUser}>
              Activate User
            </button>
          </div>
        )
